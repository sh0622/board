...
import kr.or.ddit2.post.dao.PostDao;
...
public class PostService implements PostServiceInf {
	...
	public String makePageNavi(int page, int pageSize, int totCnt, int bd_no) {
		...
		pageNaviStr.append("<li> <a href=\"/postList?bd_no="+bd_no+"&page="+ start +"&pageSize="+ pageSize +"\" aria-label=\"Previous\"> <span aria-hidden=\"true\">&laquo;</span></a> </li>");
		pageNaviStr.append("<li> <a href=\"/postList?bd_no="+bd_no+"&page="+ prevPage +"&pageSize="+ pageSize +"\" aria-label=\"Previous\"> <span aria-hidden=\"true\">&lt;</span></a> </li>");
		...
		for (int i = 1; i <= cnt; i++) {
			...
			pageNaviStr.append("<li " + actvieClass +"> <a href=\"/postList?bd_no="+bd_no+"&page=" + i + "&pageSize="+ pageSize + "\">" + i + "</a></li>");
		}

		pageNaviStr.append("<li> <a href=\"/postList?bd_no="+bd_no+"&page="+ nextPage +"&pageSize="+ pageSize +"\" aria-label=\"Next\"><span aria-hidden=\"true\">&gt;</span></a></li>");
		pageNaviStr.append("<li> <a href=\"/postList?bd_no="+bd_no+"&page="+ end +"&pageSize="+ pageSize +"\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li>");
