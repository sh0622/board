...
$(function(){
	...
	$(".btnPlus").click(function(){
		if(fileInput < total){
			var tag = "<div id=\"fileWrap\"><input type=\"file\" name=\"uploadFile"+fileInput+"\"></div>";
			$("#fileWrap").append(tag);
			fileInput++;
			$("#file_cnt").val(fileInput);
		}
		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<div class="col-xs-12 col-sm-12">
					<form class="form-horizontal" role="form" action="/postUpdate" method="post" id="frm"  enctype="multipart/form-data">
