				...
				<div class="row">
					<div class="col-xs-12 blog-main">
						...
						<div class="table-responsive ">
							...
							<form class="form-horizontal" role="form" action="/recommentRemove" method="post" id="frm4">
							...
							<div class="col-xs-12 col-sm-12" id="boardStyle" style="margin-top:20px;">
								...
								<div class="form-group "  id="fileWrap">
									...
									<div class="col-sm-10">
										<c:forEach items="${fileList }" var="list">
											<a href="/fileDownload?file_name=${list.file_name }" class="fontCss">
												${list.file_name }
											</a>
											<br>
										</c:forEach>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<form action="/recommentAdd" method="post">
