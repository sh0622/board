...
public class FileTableServiceTest {

	private FileTableServiceInf ftsi;
	private FileVo fv;
	
	@Before
	public void setup() {
		ftsi = new FileTableService();
		fv = new FileVo();
		fv.setPt_no(5);
		fv.setFile_no(37);
	...
	public void getFileListTest(){
		...
		/***When***/
		List<FileVo> fileList = ftsi.getFileList(pt_no);
	...
	public void getFileCnt(){
		...
		/***When***/
		int cnt = ftsi.getFileCnt(fv.getPt_no());
