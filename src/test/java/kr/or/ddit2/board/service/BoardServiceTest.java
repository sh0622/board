...
public class BoardServiceTest {
	...
	private BoardServiceInf bsi;
	private BoardVo boardvo;
	
	@Before
	public void setup() {
		bsi = new BoardService();
		boardvo = new BoardVo();
		boardvo.setId(1);
		boardvo.setBd_no(1);
	...
	public void getMemBoardListTest(){
		...
		/***When***/
		List<BoardVo> boardList = bsi.getMemBoardList();
	...
	public void insertBoardTest(){
		...
		/***When***/
		int intck = bsi.insertBoard(boardvo);
	...
	public void offBoard(){
		...
		/***When***/
		int bd_ck = bsi.offBoard(boardvo);
	...
	public void getBdNoVo(){
		...
		/***When***/
		BoardVo boardvo = bsi.getBdNoVo(bd_no);
