...
public class RecommentDaoTest {
	private RecommentDaoInf rdi;
	private RecommentVo rv;
	
	@Before
	public void setup(){
		rdi = new RecommentDao();
		rv = new RecommentVo();
	...
	public void getRecommentList(){
		...
		/***When***/
		List<RecommentVo> recommentList = rdi.getRecommentList(pt_no);
	...
	public void removeRecom(){
		...
		/***When***/
		int ck = rdi.removeRecom(rv.getRe_no());
